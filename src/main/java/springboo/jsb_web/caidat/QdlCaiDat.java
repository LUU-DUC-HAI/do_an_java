...
public class QdlCaiDat 
{
    ...
    public String getDuyet(Model model)
    {
        ...
        if// nếu
        (Qdl.NhanVienChuaDangNhap(request))
        {
        ...
        // model.addAttribute("content", "caidat/duyet.html"); // duyet.html
    ...
    //     //Lỗi: 
    //     // org.springframework.expression.spel.SpelEvaluationException: EL1004E: Method call: Method removeAttribute(java.lang.String) cannot be found on type org.thymeleaf.context.WebEngineContext$SessionAttributeMap
    //     // request.getSession().setAttribute("THONG_BAO_OK_SS", "Đã xóa thành công !");
    //     // <!-- <th:block th:inline="text"> [[${session.removeAttribute('THONG_BAO_OK_SS')}]]</th:block> -->
